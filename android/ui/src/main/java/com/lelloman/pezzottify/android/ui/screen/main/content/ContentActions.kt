...
@Composable
fun ContentMoreButton(onClick: () -> Unit, modifier: Modifier = Modifier) {
    FilledTonalIconButton(onClick = onClick, modifier = modifier.size(48.dp)) {
        Icon(painterResource(R.drawable.baseline_more_vert_24), stringResource(R.string.more_options))
    }
}
...
fun ContentOverflowMenu(
    ...
    Box(modifier, contentAlignment = Alignment.TopEnd) {
        ContentMoreButton(onClick = { expanded = true })

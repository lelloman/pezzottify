...
fun NavController.toBugReport() = navigate(Main.Home.BugReport)
...
fun NavController.toFullScreenImage(imageUrl: String?) {
    if (imageUrl != null) {
        navigate(Screen.Main.FullScreenImage(imageUrl))
    }
}

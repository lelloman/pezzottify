...
// Light Theme Colors - Rose Gold
private val RoseGoldPrimary = Color(0xFFB76E79)
private val RoseGoldOnPrimary = Color(0xFFFFFFFF)
private val RoseGoldPrimaryContainer = Color(0xFFFFD9DC)
private val RoseGoldOnPrimaryContainer = Color(0xFF3F0016)

private val RoseGoldSecondary = Color(0xFF75565B)
private val RoseGoldOnSecondary = Color(0xFFFFFFFF)
private val RoseGoldSecondaryContainer = Color(0xFFFFD9DD)
private val RoseGoldOnSecondaryContainer = Color(0xFF2C1519)

private val RoseGoldTertiary = Color(0xFF7B5733)
private val RoseGoldOnTertiary = Color(0xFFFFFFFF)
private val RoseGoldTertiaryContainer = Color(0xFFFFDCC4)
private val RoseGoldOnTertiaryContainer = Color(0xFF2C1600)

private val RoseGoldBackground = Color(0xFFFFFBFF)
private val RoseGoldOnBackground = Color(0xFF201A1B)
private val RoseGoldSurface = Color(0xFFFFFBFF)
private val RoseGoldOnSurface = Color(0xFF201A1B)
private val RoseGoldSurfaceVariant = Color(0xFFF3DDDF)
private val RoseGoldOnSurfaceVariant = Color(0xFF524345)

private val RoseGoldOutline = Color(0xFF847375)
private val RoseGoldOutlineVariant = Color(0xFFD6C2C3)

// Dark Theme Colors - Rose Gold
private val RoseGoldPrimaryDark = Color(0xFFFFB1B9)
private val RoseGoldOnPrimaryDark = Color(0xFF5E1129)
private val RoseGoldPrimaryContainerDark = Color(0xFF7B2941)
private val RoseGoldOnPrimaryContainerDark = Color(0xFFFFD9DC)

private val RoseGoldSecondaryDark = Color(0xFFE4BDC1)
private val RoseGoldOnSecondaryDark = Color(0xFF43292D)
private val RoseGoldSecondaryContainerDark = Color(0xFF5C3F43)
private val RoseGoldOnSecondaryContainerDark = Color(0xFFFFD9DD)

private val RoseGoldTertiaryDark = Color(0xFFEFBC8C)
private val RoseGoldOnTertiaryDark = Color(0xFF462A09)
private val RoseGoldTertiaryContainerDark = Color(0xFF60401E)
private val RoseGoldOnTertiaryContainerDark = Color(0xFFFFDCC4)

private val RoseGoldBackgroundDark = Color(0xFF201A1B)
private val RoseGoldOnBackgroundDark = Color(0xFFECE0E0)
private val RoseGoldSurfaceDark = Color(0xFF201A1B)
private val RoseGoldOnSurfaceDark = Color(0xFFECE0E0)
private val RoseGoldSurfaceVariantDark = Color(0xFF524345)
private val RoseGoldOnSurfaceVariantDark = Color(0xFFD6C2C3)

private val RoseGoldOutlineDark = Color(0xFF9F8C8E)
private val RoseGoldOutlineVariantDark = Color(0xFF524345)

// ============================================================================
// MIDNIGHT PALETTE
// ============================================================================

// Light Theme Colors - Midnight
private val MidnightPrimary = Color(0xFF3F51B5)
private val MidnightOnPrimary = Color(0xFFFFFFFF)
private val MidnightPrimaryContainer = Color(0xFFDDE1FF)
private val MidnightOnPrimaryContainer = Color(0xFF00105C)

private val MidnightSecondary = Color(0xFF5A5D72)
private val MidnightOnSecondary = Color(0xFFFFFFFF)
private val MidnightSecondaryContainer = Color(0xFFDFE1F9)
private val MidnightOnSecondaryContainer = Color(0xFF171B2C)

private val MidnightTertiary = Color(0xFF76546E)
private val MidnightOnTertiary = Color(0xFFFFFFFF)
private val MidnightTertiaryContainer = Color(0xFFFFD7F2)
private val MidnightOnTertiaryContainer = Color(0xFF2C1228)

private val MidnightBackground = Color(0xFFFBF8FF)
private val MidnightOnBackground = Color(0xFF1B1B21)
private val MidnightSurface = Color(0xFFFBF8FF)
private val MidnightOnSurface = Color(0xFF1B1B21)
private val MidnightSurfaceVariant = Color(0xFFE3E1EC)
private val MidnightOnSurfaceVariant = Color(0xFF46464F)

private val MidnightOutline = Color(0xFF777680)
private val MidnightOutlineVariant = Color(0xFFC7C5D0)

// Dark Theme Colors - Midnight
private val MidnightPrimaryDark = Color(0xFFBBC3FF)
private val MidnightOnPrimaryDark = Color(0xFF08218A)
private val MidnightPrimaryContainerDark = Color(0xFF263AA0)
private val MidnightOnPrimaryContainerDark = Color(0xFFDDE1FF)

private val MidnightSecondaryDark = Color(0xFFC3C5DD)
private val MidnightOnSecondaryDark = Color(0xFF2C2F42)
private val MidnightSecondaryContainerDark = Color(0xFF424659)
private val MidnightOnSecondaryContainerDark = Color(0xFFDFE1F9)

private val MidnightTertiaryDark = Color(0xFFE6BAD7)
private val MidnightOnTertiaryDark = Color(0xFF44263E)
private val MidnightTertiaryContainerDark = Color(0xFF5C3C55)
private val MidnightOnTertiaryContainerDark = Color(0xFFFFD7F2)

private val MidnightBackgroundDark = Color(0xFF131318)
private val MidnightOnBackgroundDark = Color(0xFFE4E1E9)
private val MidnightSurfaceDark = Color(0xFF131318)
private val MidnightOnSurfaceDark = Color(0xFFE4E1E9)
private val MidnightSurfaceVariantDark = Color(0xFF46464F)
private val MidnightOnSurfaceVariantDark = Color(0xFFC7C5D0)

private val MidnightOutlineDark = Color(0xFF90909A)
private val MidnightOutlineVariantDark = Color(0xFF46464F)

// ============================================================================
// FOREST PALETTE
// ============================================================================

// Light Theme Colors - Forest
private val ForestPrimary = Color(0xFF2E7D32)
private val ForestOnPrimary = Color(0xFFFFFFFF)
private val ForestPrimaryContainer = Color(0xFFB8F5B4)
private val ForestOnPrimaryContainer = Color(0xFF002204)

private val ForestSecondary = Color(0xFF526350)
private val ForestOnSecondary = Color(0xFFFFFFFF)
private val ForestSecondaryContainer = Color(0xFFD5E8D0)
private val ForestOnSecondaryContainer = Color(0xFF101F10)

private val ForestTertiary = Color(0xFF39656B)
private val ForestOnTertiary = Color(0xFFFFFFFF)
private val ForestTertiaryContainer = Color(0xFFBCEBF2)
private val ForestOnTertiaryContainer = Color(0xFF001F23)

private val ForestBackground = Color(0xFFFCFDF7)
private val ForestOnBackground = Color(0xFF1A1C19)
private val ForestSurface = Color(0xFFFCFDF7)
private val ForestOnSurface = Color(0xFF1A1C19)
private val ForestSurfaceVariant = Color(0xFFDEE5D9)
private val ForestOnSurfaceVariant = Color(0xFF424940)

private val ForestOutline = Color(0xFF72796F)
private val ForestOutlineVariant = Color(0xFFC2C9BD)

// Dark Theme Colors - Forest
private val ForestPrimaryDark = Color(0xFF9CD89A)
private val ForestOnPrimaryDark = Color(0xFF00390A)
private val ForestPrimaryContainerDark = Color(0xFF005313)
private val ForestOnPrimaryContainerDark = Color(0xFFB8F5B4)

private val ForestSecondaryDark = Color(0xFFB9CCB5)
private val ForestOnSecondaryDark = Color(0xFF253424)
private val ForestSecondaryContainerDark = Color(0xFF3B4B39)
private val ForestOnSecondaryContainerDark = Color(0xFFD5E8D0)

private val ForestTertiaryDark = Color(0xFFA0CFD6)
private val ForestOnTertiaryDark = Color(0xFF00363C)
private val ForestTertiaryContainerDark = Color(0xFF1F4D53)
private val ForestOnTertiaryContainerDark = Color(0xFFBCEBF2)

private val ForestBackgroundDark = Color(0xFF1A1C19)
private val ForestOnBackgroundDark = Color(0xFFE2E3DD)
private val ForestSurfaceDark = Color(0xFF1A1C19)
private val ForestOnSurfaceDark = Color(0xFFE2E3DD)
private val ForestSurfaceVariantDark = Color(0xFF424940)
private val ForestOnSurfaceVariantDark = Color(0xFFC2C9BD)

private val ForestOutlineDark = Color(0xFF8C9388)
private val ForestOutlineVariantDark = Color(0xFF424940)
...
private val RoseGoldLightColorScheme = lightColorScheme(
    ...
    onSecondary = RoseGoldOnSecondary,
    secondaryContainer = RoseGoldSecondaryContainer,
    onSecondaryContainer = RoseGoldOnSecondaryContainer,
    tertiary = RoseGoldTertiary,
    onTertiary = RoseGoldOnTertiary,
    tertiaryContainer = RoseGoldTertiaryContainer,
    onTertiaryContainer = RoseGoldOnTertiaryContainer,
    error = CommonError,
    onError = CommonOnError,
    errorContainer = CommonErrorContainer,
    onErrorContainer = CommonOnErrorContainer,
    background = RoseGoldBackground,
    onBackground = RoseGoldOnBackground,
    surface = RoseGoldSurface,
    onSurface = RoseGoldOnSurface,
    surfaceVariant = RoseGoldSurfaceVariant,
    onSurfaceVariant = RoseGoldOnSurfaceVariant,
    outline = RoseGoldOutline,
    outlineVariant = RoseGoldOutlineVariant,
)
...
private val RoseGoldDarkColorScheme = darkColorScheme(
    ...
    onBackground = RoseGoldOnBackgroundDark,
    surface = RoseGoldSurfaceDark,
    onSurface = RoseGoldOnSurfaceDark,
    surfaceVariant = RoseGoldSurfaceVariantDark,
    onSurfaceVariant = RoseGoldOnSurfaceVariantDark,
    outline = RoseGoldOutlineDark,
    outlineVariant = RoseGoldOutlineVariantDark,
)
...
private val MidnightDarkColorScheme = darkColorScheme(
    ...
    onSurfaceVariant = MidnightOnSurfaceVariantDark,
...
fun getColorScheme(palette: ColorPalette, darkTheme: Boolean): ColorScheme {
    return when (palette) {
        ...
        ColorPalette.RoseGold -> if (darkTheme) RoseGoldDarkColorScheme else RoseGoldLightColorScheme
        ColorPalette.Midnight -> if (darkTheme) MidnightDarkColorScheme else MidnightLightColorScheme
        ColorPalette.Forest -> if (darkTheme) ForestDarkColorScheme else ForestLightColorScheme
    }
}

// AMOLED true black color for backgrounds
private val AmoledBlack = Color(0xFF000000)
private val AmoledSurfaceVariant = Color(0xFF1A1A1A)

/**
 * Applies AMOLED-style true black backgrounds to a dark color scheme.
 * This replaces background and surface colors with true black for OLED power saving.
 */
fun ColorScheme.withAmoledBlacks(): ColorScheme {
    return this.copy(
...
fun getPalettePreviewColors(palette: ColorPalette): List<Color> {
    return when (palette) {
        ...
        ColorPalette.RoseGold -> listOf(
            RoseGoldPrimary,
            RoseGoldSecondary,
            RoseGoldTertiary,
            RoseGoldBackground
        )
        ColorPalette.Midnight -> listOf(
            MidnightPrimary,
            MidnightSecondary,
            MidnightTertiary,
            MidnightBackground
        )
        ColorPalette.Forest -> listOf(
            ForestPrimary,
            ForestSecondary,
            ForestTertiary,
            ForestBackground
